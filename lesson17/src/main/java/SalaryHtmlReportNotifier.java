...
public class SalaryHtmlReportNotifier {
    ...
    public void processEachRowOfQueryResult(ResultSet results, StringBuilder resultingHtml) throws SQLException {
        double totals = 0;
        while (results.next()) {
        ...
        sendReportToTheRecipientsList();
    }

    public void sendReportToTheRecipientsList(){
        try {
    ...
    public void generateAndSendHtmlSalaryReport(String departmentId, LocalDate dateFrom, LocalDate dateTo, String recipients) {
        try {
            ...
            processEachRowOfQueryResult(results, resultingHtml);
